...
import { OfficeImg, PageTitle } from '../styles/shared';
...
const About = ({ data }) => {
  ...
  return (
    <Layout>
      ...
      <p>
        I really love what I do and consider it a creative passion. It's helped
        me build a great set of professional and personal skills such as having
        a very good eye for detail (pixel perfect), being able to balance
        creative designs whilst maintaining good usability, accurately and
        efficiently managing my time and I'm also very easy to get along with.
      </p>
      <p>
        ...
        product life cycle in a range of different environments. I've also been
        involved in architectural decisions, usability testing, wireframing,
        design mocking, prototyping and proof of concepts.
      </p>
      <OfficeImg
        alt="French Connection head office"
        height="405"
        image={image}
        width="720"
      />
      <p>
        ...
        Please feel free to run a lighthouse test on my portfolio, I'm really
        happy with the scores but I'm always seeking out ways of improving them.
      </p>
      <figure>
        <blockquote>
      ...
      <p>
        ...
        great companies in the past, you can find some previous examples of my
        work in my <Link to="/portfolio">portfolio</Link>.
      </p>
    </Layout>
  );
};
